...
def MOF_inference(model, cfg):
    ...
    input_images = input_images[None].cuda(2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seq_dir', default='demo_input_images')
    ...
    model = torch.nn.DataParallel(build_network(cfg), device_ids=[2, 1])
